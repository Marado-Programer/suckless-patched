 ...
 */
static char *shell = "user/bin/zsh";
char *utmp = NULL;
 ...
 * attribute.
 */
static unsigned int blinktimeout = 768;
 ...
 * it
 */
static int bellvolume = 64;

/* visual-bell timeout in ms (0 to disable visual-bell) */
static int vbelltimeout = 128;
